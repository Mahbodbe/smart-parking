...
| نام و نام خانوادگی | پروفایل گیت‌هاب | نقش و مسئولیت |
| :--- | :--- | :--- |
| **مهبد بمانی‌چم** | [@Mahbodbe](https://github.com/Mahbodbe) | معماری سخت‌افزار، سیستم DAQ و سرپرست پروژه |
| **عرفان اشکش** | [@THEEA8](https://github.com/THEEA8) | سیستم‌های نهفته و شبیه‌سازی پروتئوس |
| **مانی محمدی** | [@loManiol](https://github.com/loManiol) | سیستم‌های بک‌اند و تحلیل کنترل |
